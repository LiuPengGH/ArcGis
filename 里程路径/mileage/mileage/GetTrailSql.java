...
public class GetTrailSql {
    ...
    public static String getTrailSql(ResultSet resultSet, String format, String phone) {
        ...
        try {
            ...
            if (date == null || !date.substring(0, 10).equals(format)) {
                ...
                trailSql = GetTrailPath.getTrailPath(phone, format + " 08:30:00", format + " 17:00:00");
                ...
                try {
                    ...
                    if (dateD.getTime() >= today.getTime() && today.getTime() >= startday.getTime()) {
                        trailSql = GetTrailPath.getTrailPath(phone, date, format + " 17:00:00");
                    } else {
                        trailSql = GetTrailPath.getTrailPath(phone, format + " 08:30:00", format + " 17:00:00");
                    }
